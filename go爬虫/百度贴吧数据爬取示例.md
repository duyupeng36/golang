...
func main() {
	...
	for i := 0; i < *pageNum; i++ {
		...
		params.addNode("kw", "王者荣耀")
		params.addNode("ie", "utf-8")
		params.addNode("cid", "")
		params.addNode("tab", "corearea")
		params.addNode("pn", strconv.Itoa(i*50))
		req.URL.RawQuery = params.Encode()

		// 添加请求头
		req.Header.addNode("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36")
